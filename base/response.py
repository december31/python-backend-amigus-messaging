...
conversation_not_found = HttpStatus(status.HTTP_404_NOT_FOUND, code=4042, message="conversation not found")
...
bad_request = HttpStatus(status.HTTP_400_BAD_REQUEST, code=400, message="bad request")
...
phone_already_registered = HttpStatus(status.HTTP_500_INTERNAL_SERVER_ERROR, code=4091,
                                      message="account with this phone number has already registered")
...
invalid_token = HttpStatus(status.HTTP_401_UNAUTHORIZED, code=4014, message="invalid_token")
token_expired = HttpStatus(status.HTTP_401_UNAUTHORIZED, code=4015, message="token expired")
account_does_not_existed = HttpStatus(status.HTTP_401_UNAUTHORIZED, code=4016, message="Account has not been registered")
password_is_incorrect = HttpStatus(status.HTTP_401_UNAUTHORIZED, code=4017, message="Password is incorrect")
